    ...
    .map(ship => {
      ...
      if (numOfPlanets >= 0) {
        ...
        return ship.navigate({
          target: vulnerableShips[0] || gameMap.enemyShips[0],
      ...
      if (ship.canDock(chosenPlanet)) {
        ...
        /*
         ...
         Don't worry about pathfinding for now, as the goal will do it for you.
         We run this navigate goal each turn until we arrive to get the latest move.
         Here we move at half our maximum speed to better control the ships.
         Navigate goal is an example and most likely you will have to design your own.
         */
        return ship.navigate({
          target: chosenPlanet,
